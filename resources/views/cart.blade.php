...
<!--  -->
    <div class="container" >
        <div class="col-lg-7">
            <a class="fas fa-shopping-cart" href="{{ route('cart.index') }}"><span>  TU CARRITO</span></a>
        </div>
        <a class="fas fa-arrow-down" href="{{ route('cart.index') }}"><span>  CONTINUA CON LA COMPRA</span></a>
